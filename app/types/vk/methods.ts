...
export interface APIAccount {
   ...
   */
  changePassword(
    params: Params.AccountChangePasswordParams,
  ): Promise<Responses.AccountChangePasswordResponse>
  /**
   * Returns a list of active ads (offers) which executed by the user will bring him/her respective number of votes to his balance in the application.
   */
  getActiveOffers(
    params: Params.AccountGetActiveOffersParams,
  ): Promise<Responses.AccountGetActiveOffersResponse>
  /**
   * Gets settings of the user in this application.
   */
  getAppPermissions(
    params: Params.AccountGetAppPermissionsParams,
   ...
   */
  getCounters(
    params: Params.AccountGetCountersParams,
  ): Promise<Responses.AccountGetCountersResponse>
  /**
   ...
   */
  getProfileInfo(
    params: Params.AccountGetProfileInfoParams,
  ): Promise<Responses.AccountGetProfileInfoResponse>
  /**
   * Gets settings of push notifications.
   */
  getPushSettings(
    params: Params.AccountGetPushSettingsParams,
  ): Promise<Responses.AccountGetPushSettingsResponse>
  /**
   ...
   */
  saveProfileInfo(
    params: Params.AccountSaveProfileInfoParams,
  ): Promise<Responses.AccountSaveProfileInfoResponse>
  /**
...
export interface APIAds {
   ...
   */
  createCampaigns(
    params: Params.AdsCreateCampaignsParams,
  ): Promise<Responses.AdsCreateCampaignsResponse>
  /**
   ...
   */
  createTargetGroup(
    params: Params.AdsCreateTargetGroupParams,
  ): Promise<Responses.AdsCreateTargetGroupResponse>
  /**
   * Archives ads.
   */
   ...
   */
  deleteCampaigns(
    params: Params.AdsDeleteCampaignsParams,
  ): Promise<Responses.AdsDeleteCampaignsResponse>
  /**
   ...
   */
  getAdsTargeting(
    params: Params.AdsGetAdsTargetingParams,
  ): Promise<Responses.AdsGetAdsTargetingResponse>
  /**
   ...
   */
  getDemographics(
    params: Params.AdsGetDemographicsParams,
  ): Promise<Responses.AdsGetDemographicsResponse>
  /**
  ...
  getLookalikeRequests(
    params: Params.AdsGetLookalikeRequestsParams,
  ): Promise<Responses.AdsGetLookalikeRequestsResponse>
  getMusicians(params: Params.AdsGetMusiciansParams): Promise<Responses.AdsGetMusiciansResponse>
  getMusiciansByIds(
    params: Params.AdsGetMusiciansByIdsParams,
  ): Promise<Responses.AdsGetMusiciansResponse>
  /**
   * Returns a list of managers and supervisors of advertising account.
   */
  getOfficeUsers(
    params: Params.AdsGetOfficeUsersParams,
  ): Promise<Responses.AdsGetOfficeUsersResponse>
  /**
  ...
  ): Promise<Responses.AdsGetRejectionReasonResponse>
  /**
   ...
   */
  getTargetGroups(
    params: Params.AdsGetTargetGroupsParams,
  ): Promise<Responses.AdsGetTargetGroupsResponse>
  /**
   * Returns the size of targeting audience, and also recommended values for CPC and CPM.
   */
  getTargetingStats(
    params: Params.AdsGetTargetingStatsParams,
  ): Promise<Responses.AdsGetTargetingStatsResponse>
  /**
   ...
   */
  getVideoUploadURL(
    params: Params.AdsGetVideoUploadURLParams,
  ): Promise<Responses.AdsGetVideoUploadURLResponse>
  /**
   * Imports a list of advertiser's contacts to count VK registered users against the target group.
   */
  importTargetContacts(
    params: Params.AdsImportTargetContactsParams,
  ): Promise<Responses.AdsImportTargetContactsResponse>
  /**
   * Removes managers and/or supervisors from advertising account.
   */
  removeOfficeUsers(
    params: Params.AdsRemoveOfficeUsersParams,
  ): Promise<Responses.AdsRemoveOfficeUsersResponse>
  /**
   * Edits ads.
   */
   ...
   */
  updateCampaigns(
    params: Params.AdsUpdateCampaignsParams,
  ): Promise<Responses.AdsUpdateCampaignsResponse>
  /**
   ...
   */
  updateOfficeUsers(
    params: Params.AdsUpdateOfficeUsersParams,
  ): Promise<Responses.AdsUpdateOfficeUsersResponse>
  /**
...
export interface APIAdsweb {
  getAdCategories(
    params: Params.AdswebGetAdCategoriesParams,
  ): Promise<Responses.AdswebGetAdCategoriesResponse>
  getAdUnitCode(
    params: Params.AdswebGetAdUnitCodeParams,
  ): Promise<Responses.AdswebGetAdUnitCodeResponse>
  getAdUnits(params: Params.AdswebGetAdUnitsParams): Promise<Responses.AdswebGetAdUnitsResponse>
  getFraudHistory(
    params: Params.AdswebGetFraudHistoryParams,
  ): Promise<Responses.AdswebGetFraudHistoryResponse>
  getSites(params: Params.AdswebGetSitesParams): Promise<Responses.AdswebGetSitesResponse>
  getStatistics(
    params: Params.AdswebGetStatisticsParams,
  ): Promise<Responses.AdswebGetStatisticsResponse>
}
...
export interface APIAppWidgets {
  ...
  getAppImageUploadServer(
    params: Params.AppWidgetsGetAppImageUploadServerParams,
  ): Promise<Responses.AppWidgetsGetAppImageUploadServerResponse>
  /**
   * Returns an app collection of images for community app widgets
   */
  getAppImages(
    params: Params.AppWidgetsGetAppImagesParams,
  ): Promise<Responses.AppWidgetsGetAppImagesResponse>
  /**
   * Returns a URL for uploading a photo to the community collection for community app widgets
   */
  getGroupImageUploadServer(
    params: Params.AppWidgetsGetGroupImageUploadServerParams,
   ...
   */
  getGroupImages(
    params: Params.AppWidgetsGetGroupImagesParams,
  ): Promise<Responses.AppWidgetsGetGroupImagesResponse>
  /**
   * Returns an image for community app widgets by its ID
   */
  getImagesById(
    params: Params.AppWidgetsGetImagesByIdParams,
  ): Promise<Responses.AppWidgetsGetImagesByIdResponse>
  /**
   * Allows to save image into app collection for community app widgets
   */
  saveAppImage(
    params: Params.AppWidgetsSaveAppImageParams,
  ): Promise<Responses.AppWidgetsSaveAppImageResponse>
  /**
   * Allows to save image into community collection for community app widgets
   */
  saveGroupImage(
    params: Params.AppWidgetsSaveGroupImageParams,
  ): Promise<Responses.AppWidgetsSaveGroupImageResponse>
  /**
...
export interface APIApps {
   ...
   */
  getMiniAppPolicies(
    params: Params.AppsGetMiniAppPoliciesParams,
  ): Promise<Responses.AppsGetMiniAppPoliciesResponse>
  /**
  ...
  promoHasActiveGift(
    params: Params.AppsPromoHasActiveGiftParams,
  ): Promise<Responses.BaseBoolResponse>
...
export interface APIBoard {
   ...
   */
  createComment(
    params: Params.BoardCreateCommentParams,
  ): Promise<Responses.BoardCreateCommentResponse>
  /**
...
export interface APIDatabase {
   ...
   */
  getCitiesById(
    params: Params.DatabaseGetCitiesByIdParams,
  ): Promise<Responses.DatabaseGetCitiesByIdResponse>
  /**
   * Returns a list of countries.
   */
  getCountries(
    params: Params.DatabaseGetCountriesParams,
  ): Promise<Responses.DatabaseGetCountriesResponse>
  /**
   * Returns information about countries by their IDs.
   */
  getCountriesById(
    params: Params.DatabaseGetCountriesByIdParams,
  ): Promise<Responses.DatabaseGetCountriesByIdResponse>
  /**
   * Returns a list of faculties (i.e., university departments).
   */
  getFaculties(
    params: Params.DatabaseGetFacultiesParams,
  ): Promise<Responses.DatabaseGetFacultiesResponse>
  /**
   * Get metro stations by city
   */
  getMetroStations(
    params: Params.DatabaseGetMetroStationsParams,
  ): Promise<Responses.DatabaseGetMetroStationsResponse>
  /**
   * Get metro station by his id
   */
  getMetroStationsById(
    params: Params.DatabaseGetMetroStationsByIdParams,
  ): Promise<Responses.DatabaseGetMetroStationsByIdResponse>
  /**
   ...
   */
  getSchoolClasses(
    params: Params.DatabaseGetSchoolClassesParams,
  ): Promise<Responses.DatabaseGetSchoolClassesResponse>
  /**
   ...
   */
  getUniversities(
    params: Params.DatabaseGetUniversitiesParams,
  ): Promise<Responses.DatabaseGetUniversitiesResponse>
}
...
export interface APIDocs {
  ...
  getMessagesUploadServer(
    params: Params.DocsGetMessagesUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
   ...
   */
  getUploadServer(
    params: Params.DocsGetUploadServerParams,
  ): Promise<Responses.DocsGetUploadServerResponse>
  /**
   * Returns the server address for document upload onto a user's or community's wall.
   */
  getWallUploadServer(
    params: Params.DocsGetWallUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
...
export interface APIDonut {
  getFriends(
    params: Params.DonutGetFriendsParams,
  ): Promise<Responses.GroupsGetMembersFieldsResponse>
  getSubscription(
    params: Params.DonutGetSubscriptionParams,
  ): Promise<Responses.DonutGetSubscriptionResponse>
  /**
   * Returns a list of user's VK Donut subscriptions.
   */
  getSubscriptions(
    params: Params.DonutGetSubscriptionsParams,
  ): Promise<Responses.DonutGetSubscriptionsResponse>
...
export interface APIDownloadedGames {
  getPaidStatus(
    params: Params.DownloadedGamesGetPaidStatusParams,
  ): Promise<Responses.DownloadedGamesPaidStatusResponse>
}
...
export interface APIFave {
  ...
  trackPageInteraction(
    params: Params.FaveTrackPageInteractionParams,
...
export interface APIFriends {
   ...
   */
  deleteAllRequests(
    params: Params.FriendsDeleteAllRequestsParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   ...
   */
  getAppUsers(
    params: Params.FriendsGetAppUsersParams,
  ): Promise<Responses.FriendsGetAppUsersResponse>
  /**
   * Returns a list of the current user's friends whose phone numbers, validated or specified in a profile, are in a given list.
   */
  getByPhones(
    params: Params.FriendsGetByPhonesParams,
  ): Promise<Responses.FriendsGetByPhonesResponse>
  /**
   ...
   */
  getSuggestions(
    params: Params.FriendsGetSuggestionsParams,
  ): Promise<Responses.FriendsGetSuggestionsResponse>
  /**
...
export interface APIGroups {
  ...
  addCallbackServer(
    params: Params.GroupsAddCallbackServerParams,
  ): Promise<Responses.GroupsAddCallbackServerResponse>
  /**
  ...
  deleteCallbackServer(
    params: Params.GroupsDeleteCallbackServerParams,
  ): Promise<Responses.BaseOkResponse>
  /**
  ...
  editCallbackServer(
    params: Params.GroupsEditCallbackServerParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   ...
   */
  getAddresses(
    params: Params.GroupsGetAddressesParams,
  ): Promise<Responses.GroupsGetAddressesResponse>
  /**
  ...
  getCallbackConfirmationCode(
    params: Params.GroupsGetCallbackConfirmationCodeParams,
  ): Promise<Responses.GroupsGetCallbackConfirmationCodeResponse>
  getCallbackServers(
    params: Params.GroupsGetCallbackServersParams,
  ): Promise<Responses.GroupsGetCallbackServersResponse>
  /**
   * Returns [vk.com/dev/callback_api|Callback API] notifications settings.
   */
  getCallbackSettings(
    params: Params.GroupsGetCallbackSettingsParams,
   ...
   */
  getInvitedUsers(
    params: Params.GroupsGetInvitedUsersParams,
  ): Promise<Responses.GroupsGetInvitedUsersResponse>
  /**
   ...
   */
  getLongPollServer(
    params: Params.GroupsGetLongPollServerParams,
  ): Promise<Responses.GroupsGetLongPollServerResponse>
  /**
   * Returns Long Poll notification settings
   */
  getLongPollSettings(
    params: Params.GroupsGetLongPollSettingsParams,
  ): Promise<Responses.GroupsGetLongPollSettingsResponse>
  /**
  ...
  getTokenPermissions(
    params: Params.GroupsGetTokenPermissionsParams,
  ): Promise<Responses.GroupsGetTokenPermissionsResponse>
  /**
   ...
   */
  setCallbackSettings(
    params: Params.GroupsSetCallbackSettingsParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   * Sets Long Poll notification settings
   */
  setLongPollSettings(
    params: Params.GroupsSetLongPollSettingsParams,
  ): Promise<Responses.BaseOkResponse>
...
export interface APIMarket {
   ...
   */
  createComment(
    params: Params.MarketCreateCommentParams,
  ): Promise<Responses.MarketCreateCommentResponse>
  /**
   * Deletes an item.
   */
   ...
   */
  deleteComment(
    params: Params.MarketDeleteCommentParams,
  ): Promise<Responses.MarketDeleteCommentResponse>
  /**
   * Edits an item.
   */
   ...
   */
  getAlbumById(
    params: Params.MarketGetAlbumByIdParams,
  ): Promise<Responses.MarketGetAlbumByIdResponse>
  /**
   ...
   */
  getCategories(
    params: Params.MarketGetCategoriesParams,
  ): Promise<Responses.MarketGetCategoriesResponse>
  /**
   ...
   */
  getGroupOrders(
    params: Params.MarketGetGroupOrdersParams,
  ): Promise<Responses.MarketGetGroupOrdersResponse>
  /**
   * Get order
   */
  getOrderById(
    params: Params.MarketGetOrderByIdParams,
  ): Promise<Responses.MarketGetOrderByIdResponse>
  /**
   ...
   */
  restoreComment(
    params: Params.MarketRestoreCommentParams,
  ): Promise<Responses.MarketRestoreCommentResponse>
  /**
...
export interface APIMessages {
  ...
  allowMessagesFromGroup(
    params: Params.MessagesAllowMessagesFromGroupParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   ...
   */
  deleteChatPhoto(
    params: Params.MessagesDeleteChatPhotoParams,
  ): Promise<Responses.MessagesDeleteChatPhotoResponse>
  /**
   * Deletes all private messages in a conversation.
   */
  deleteConversation(
    params: Params.MessagesDeleteConversationParams,
  ): Promise<Responses.MessagesDeleteConversationResponse>
  /**
  ...
  getChatPreview(
    params: Params.MessagesGetChatPreviewParams,
  ): Promise<Responses.MessagesGetChatPreviewResponse>
  /**
   * Returns a list of IDs of users participating in a chat.
   */
  getConversationMembers(
    params: Params.MessagesGetConversationMembersParams,
  ): Promise<Responses.MessagesGetConversationMembersResponse>
  /**
   * Returns a list of the current user's conversations.
   */
  getConversations(
    params: Params.MessagesGetConversationsParams,
  ): Promise<Responses.MessagesGetConversationsResponse>
  /**
   * Returns conversations by their IDs
   */
  getConversationsById(
    params: Params.MessagesGetConversationsByIdParams,
  ): Promise<Responses.MessagesGetConversationsByIdResponse>
  /**
  ...
  getHistoryAttachments(
    params: Params.MessagesGetHistoryAttachmentsParams,
  ): Promise<Responses.MessagesGetHistoryAttachmentsResponse>
  /**
  ...
  getIntentUsers(
    params: Params.MessagesGetIntentUsersParams,
  ): Promise<Responses.MessagesGetIntentUsersResponse>
  getInviteLink(
   ...
   */
  getLastActivity(
    params: Params.MessagesGetLastActivityParams,
  ): Promise<Responses.MessagesGetLastActivityResponse>
  /**
   * Returns updates in user's private messages.
   */
  getLongPollHistory(
    params: Params.MessagesGetLongPollHistoryParams,
  ): Promise<Responses.MessagesGetLongPollHistoryResponse>
  /**
   * Returns data required for connection to a Long Poll server.
   */
  getLongPollServer(
    params: Params.MessagesGetLongPollServerParams,
  ): Promise<Responses.MessagesGetLongPollServerResponse>
  /**
   * Returns information whether sending messages from the community to current user is allowed.
   */
  isMessagesFromGroupAllowed(
    params: Params.MessagesIsMessagesFromGroupAllowedParams,
  ): Promise<Responses.MessagesIsMessagesFromGroupAllowedResponse>
  joinChatByInviteLink(
    params: Params.MessagesJoinChatByInviteLinkParams,
  ): Promise<Responses.MessagesJoinChatByInviteLinkResponse>
  /**
   ...
   */
  markAsImportant(
    params: Params.MessagesMarkAsImportantParams,
  ): Promise<Responses.MessagesMarkAsImportantResponse>
  /**
  ...
  sendMessageEventAnswer(
    params: Params.MessagesSendMessageEventAnswerParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   ...
   */
  setChatPhoto(
    params: Params.MessagesSetChatPhotoParams,
  ): Promise<Responses.MessagesSetChatPhotoResponse>
...
export interface APINewsfeed {
   ...
   */
  getComments(
    params: Params.NewsfeedGetCommentsParams,
  ): Promise<Responses.NewsfeedGetCommentsResponse>
  /**
   ...
   */
  getMentions(
    params: Params.NewsfeedGetMentionsParams,
  ): Promise<Responses.NewsfeedGetMentionsResponse>
  /**
   * , Returns a list of newsfeeds recommended to the current user.
   */
  getRecommended(
    params: Params.NewsfeedGetRecommendedParams,
  ): Promise<Responses.NewsfeedGetRecommendedResponse>
  /**
   * Returns communities and users that current user is suggested to follow.
   */
  getSuggestedSources(
    params: Params.NewsfeedGetSuggestedSourcesParams,
  ): Promise<Responses.NewsfeedGetSuggestedSourcesResponse>
  /**
...
export interface APINotes {
   ...
   */
  createComment(
    params: Params.NotesCreateCommentParams,
  ): Promise<Responses.NotesCreateCommentResponse>
  /**
...
export interface APINotifications {
   ...
   */
  markAsViewed(
    params: Params.NotificationsMarkAsViewedParams,
  ): Promise<Responses.NotificationsMarkAsViewedResponse>
  sendMessage(
    params: Params.NotificationsSendMessageParams,
  ): Promise<Responses.NotificationsSendMessageResponse>
}
...
export interface APIOrders {
  cancelSubscription(
    params: Params.OrdersCancelSubscriptionParams,
  ): Promise<Responses.OrdersCancelSubscriptionResponse>
  /**
  ...
  ): Promise<Responses.OrdersGetUserSubscriptionByIdResponse>
  getUserSubscriptions(
    params: Params.OrdersGetUserSubscriptionsParams,
  ): Promise<Responses.OrdersGetUserSubscriptionsResponse>
  updateSubscription(
    params: Params.OrdersUpdateSubscriptionParams,
  ): Promise<Responses.OrdersUpdateSubscriptionResponse>
}
...
export interface APIPhotos {
   ...
   */
  createComment(
    params: Params.PhotosCreateCommentParams,
  ): Promise<Responses.PhotosCreateCommentResponse>
  /**
   * Deletes a photo.
   */
   ...
   */
  deleteComment(
    params: Params.PhotosDeleteCommentParams,
  ): Promise<Responses.PhotosDeleteCommentResponse>
  /**
   ...
   */
  getAlbumsCount(
    params: Params.PhotosGetAlbumsCountParams,
  ): Promise<Responses.PhotosGetAlbumsCountResponse>
  /**
   ...
   */
  getAllComments(
    params: Params.PhotosGetAllCommentsParams,
  ): Promise<Responses.PhotosGetAllCommentsResponse>
  /**
   ...
   */
  getChatUploadServer(
    params: Params.PhotosGetChatUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
  ...
  getMarketAlbumUploadServer(
    params: Params.PhotosGetMarketAlbumUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
   * Returns the server address for market photo upload.
   */
  getMarketUploadServer(
    params: Params.PhotosGetMarketUploadServerParams,
  ): Promise<Responses.PhotosGetMarketUploadServerResponse>
  /**
   * Returns the server address for photo upload in a private message for a user.
   */
  getMessagesUploadServer(
    params: Params.PhotosGetMessagesUploadServerParams,
  ): Promise<Responses.PhotosGetMessagesUploadServerResponse>
  /**
  ...
  getOwnerCoverPhotoUploadServer(
    params: Params.PhotosGetOwnerCoverPhotoUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
   * Returns an upload server address for a profile or community photo.
   */
  getOwnerPhotoUploadServer(
    params: Params.PhotosGetOwnerPhotoUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
   ...
   */
  getUploadServer(
    params: Params.PhotosGetUploadServerParams,
  ): Promise<Responses.PhotosGetUploadServerResponse>
  /**
   * Returns a list of photos in which a user is tagged.
   */
  getUserPhotos(
    params: Params.PhotosGetUserPhotosParams,
  ): Promise<Responses.PhotosGetUserPhotosResponse>
  /**
   * Returns the server address for photo upload onto a user's wall.
   */
  getWallUploadServer(
    params: Params.PhotosGetWallUploadServerParams,
  ): Promise<Responses.PhotosGetWallUploadServerResponse>
  /**
   ...
   */
  restoreComment(
    params: Params.PhotosRestoreCommentParams,
  ): Promise<Responses.PhotosRestoreCommentResponse>
  /**
  ...
  saveMarketAlbumPhoto(
    params: Params.PhotosSaveMarketAlbumPhotoParams,
  ): Promise<Responses.PhotosSaveMarketAlbumPhotoResponse>
  /**
   * Saves market photos after successful uploading.
   */
  saveMarketPhoto(
    params: Params.PhotosSaveMarketPhotoParams,
  ): Promise<Responses.PhotosSaveMarketPhotoResponse>
  /**
   * Saves a photo after being successfully uploaded. URL obtained with [vk.com/dev/photos.getMessagesUploadServer|photos.getMessagesUploadServer] method.
   */
  saveMessagesPhoto(
    params: Params.PhotosSaveMessagesPhotoParams,
  ): Promise<Responses.PhotosSaveMessagesPhotoResponse>
  /**
   * Saves cover photo after successful uploading.
   */
  saveOwnerCoverPhoto(
    params: Params.PhotosSaveOwnerCoverPhotoParams,
  ): Promise<Responses.PhotosSaveOwnerCoverPhotoResponse>
  /**
   * Saves a profile or community photo. Upload URL can be got with the [vk.com/dev/photos.getOwnerPhotoUploadServer|photos.getOwnerPhotoUploadServer] method.
   */
  saveOwnerPhoto(
    params: Params.PhotosSaveOwnerPhotoParams,
  ): Promise<Responses.PhotosSaveOwnerPhotoResponse>
  /**
   * Saves a photo to a user's or community's wall after being uploaded.
   */
  saveWallPhoto(
    params: Params.PhotosSaveWallPhotoParams,
  ): Promise<Responses.PhotosSaveWallPhotoResponse>
  /**
...
export interface APIPodcasts {
  searchPodcast(
    params: Params.PodcastsSearchPodcastParams,
  ): Promise<Responses.PodcastsSearchPodcastResponse>
}
...
export interface APIPolls {
  ...
  getBackgrounds(
    params: Params.PollsGetBackgroundsParams,
  ): Promise<Responses.PollsGetBackgroundsResponse>
  /**
   * Returns detailed information about a poll by its ID.
   */
  getById(params: Params.PollsGetByIdParams): Promise<Responses.PollsGetByIdResponse>
  getPhotoUploadServer(
    params: Params.PollsGetPhotoUploadServerParams,
  ): Promise<Responses.BaseGetUploadServerResponse>
  /**
...
export interface APIPrettyCards {
  ...
  getUploadURL(
    params: Params.PrettyCardsGetUploadURLParams,
  ): Promise<Responses.PrettyCardsGetUploadURLResponse>
}
...
export interface APISecure {
   ...
   */
  getAppBalance(
    params: Params.SecureGetAppBalanceParams,
  ): Promise<Responses.SecureGetAppBalanceResponse>
  /**
   * Shows a list of SMS notifications sent by the application using [vk.com/dev/secure.sendSMSNotification|secure.sendSMSNotification] method.
   */
  getSMSHistory(
    params: Params.SecureGetSMSHistoryParams,
  ): Promise<Responses.SecureGetSmsHistoryResponse>
  /**
   * Shows history of votes transaction between users and the application.
   */
  getTransactionsHistory(
    params: Params.SecureGetTransactionsHistoryParams,
  ): Promise<Responses.SecureGetTransactionsHistoryResponse>
  /**
   * Returns one of the previously set game levels of one or more users in the application.
   */
  getUserLevel(
    params: Params.SecureGetUserLevelParams,
  ): Promise<Responses.SecureGetUserLevelResponse>
  /**
   * Opens the game achievement and gives the user a sticker
   */
  giveEventSticker(
    params: Params.SecureGiveEventStickerParams,
  ): Promise<Responses.SecureGiveEventStickerResponse>
  /**
   * Sends notification to the user.
   */
  sendNotification(
    params: Params.SecureSendNotificationParams,
  ): Promise<Responses.SecureSendNotificationResponse>
  /**
   * Sends 'SMS' notification to a user's mobile device.
   */
  sendSMSNotification(
    params: Params.SecureSendSMSNotificationParams,
  ): Promise<Responses.BaseOkResponse>
  /**
...
export interface APIStore {
  ...
  addStickersToFavorite(
    params: Params.StoreAddStickersToFavoriteParams,
  ): Promise<Responses.BaseOkResponse>
  getFavoriteStickers(
    params: Params.StoreGetFavoriteStickersParams,
  ): Promise<Responses.StoreGetFavoriteStickersResponse>
  getProducts(params: Params.StoreGetProductsParams): Promise<Responses.StoreGetProductsResponse>
  getStickersKeywords(
    params: Params.StoreGetStickersKeywordsParams,
  ): Promise<Responses.StoreGetStickersKeywordsResponse>
  /**
   * Removes given sticker IDs from the list of user's favorite stickers
   */
  removeStickersFromFavorite(
    params: Params.StoreRemoveStickersFromFavoriteParams,
  ): Promise<Responses.BaseOkResponse>
}
...
export interface APIStories {
   ...
   */
  getPhotoUploadServer(
    params: Params.StoriesGetPhotoUploadServerParams,
  ): Promise<Responses.StoriesGetPhotoUploadServerResponse>
  /**
  ...
  getVideoUploadServer(
    params: Params.StoriesGetVideoUploadServerParams,
  ): Promise<Responses.StoriesGetVideoUploadServerResponse>
  /**
   * Returns a list of story viewers.
   */
  getViewers(
    params: Params.StoriesGetViewersParams,
  ): Promise<Responses.StoriesGetViewersExtendedV5115Response>
  /**
...
export interface APIStreaming {
   ...
   */
  getServerUrl(
    params: Params.StreamingGetServerUrlParams,
  ): Promise<Responses.StreamingGetServerUrlResponse>
...
export interface APIUtils {
  ...
  deleteFromLastShortened(
    params: Params.UtilsDeleteFromLastShortenedParams,
  ): Promise<Responses.BaseOkResponse>
  /**
   * Returns a list of user's shortened links.
   */
  getLastShortenedLinks(
    params: Params.UtilsGetLastShortenedLinksParams,
  ): Promise<Responses.UtilsGetLastShortenedLinksResponse>
  /**
   ...
   */
  getServerTime(
    params: Params.UtilsGetServerTimeParams,
  ): Promise<Responses.UtilsGetServerTimeResponse>
  /**
   ...
   */
  resolveScreenName(
    params: Params.UtilsResolveScreenNameParams,
  ): Promise<Responses.UtilsResolveScreenNameResponse>
}
...
export interface APIVideo {
   ...
   */
  createComment(
    params: Params.VideoCreateCommentParams,
  ): Promise<Responses.VideoCreateCommentResponse>
  /**
   ...
   */
  restoreComment(
    params: Params.VideoRestoreCommentParams,
  ): Promise<Responses.VideoRestoreCommentResponse>
  /**
...
export interface APIWall {
  checkCopyrightLink(
    params: Params.WallCheckCopyrightLinkParams,
  ): Promise<Responses.BaseBoolResponse>
   ...
   */
  createComment(
    params: Params.WallCreateCommentParams,
  ): Promise<Responses.WallCreateCommentResponse>
  /**
   ...
   */
  postAdsStealth(
    params: Params.WallPostAdsStealthParams,
  ): Promise<Responses.WallPostAdsStealthResponse>
  /**
...
export interface APIWidgets {
   ...
   */
  getComments(
    params: Params.WidgetsGetCommentsParams,
  ): Promise<Responses.WidgetsGetCommentsResponse>
  /**
