...
type IConversationActionType = 'chat_photo_update' | 'chat_photo_remove' | 'chat_create' | 'chat_title_update' | 'chat_invite_user' | 'chat_kick_user' | 'chat_pin_message' | 'chat_unpin_message' | 'chat_invite_user_by_link'
...
export { IBooleanNum, ICropData, IUserCity, IUserContacts, IBaseProfile, IMessage, IConversation, IConversationPhoto,
    IMessageID, IPushSettings, IPeer, IAttachment, IConversationActionType, IConversationsResponseItem, ICropPhoto, UnixDate, ICropRect, ChatSettingsState,
    IFriendStatus, IGeo, IPeerID, IProfile, IProfileCounters, IProfileEducation, IUserCountry}
