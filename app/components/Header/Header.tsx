    ...
    >
      ...
      >
        {props.options.headerBackVisible && props.navigation.canGoBack() ? (
          <TouchableOpacity onPress={props.navigation.goBack}>
            ...
            {props.back?.title && props.options.headerBackTitleVisible && (
              <Text>{props.back?.title}</Text>
            )}
          </TouchableOpacity>
        ) : (
          props.options.headerLeft &&
          props.options.headerLeft({ tintColor: props.options.headerTintColor })
        )}
      </View>
      <View
        style={[
      ...
      <View style={styles.right}>
        {props.options.headerRight &&
          props.options.headerRight({ tintColor: props.options.headerTintColor })}
      </View>
    </BlurView>
  )
}
