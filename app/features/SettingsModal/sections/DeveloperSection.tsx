...
export const DeveloperSection = () => {
  ...
  const rows: SectionRow[] = [
    ...
    {
      title: `${translate("SettingsModal.debug_clear_conversations" as TxKeyPath)}`,
      onPress: reloadConversationsCache,
    },
    {
      title: `${translate("SettingsModal.debug_clear_messages" as TxKeyPath)}`,
      onPress: () => dispatch.history.reset(),
    },
  ]

  return <Section header={"Разработчик"} rows={rows} />
}
